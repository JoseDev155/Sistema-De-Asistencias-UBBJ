...
@enrollment_controller.get("/enrollments", tags=["enrollments"],
                           description="Endpoint para obtener todas las inscripciones del sistema. Solo Admin.",
...
@enrollment_controller.get("/enrollments/{id}", tags=["enrollments"],
                           description="Endpoint para obtener una inscripción específica por su ID. Solo Admin.",
...
@enrollment_controller.get("/enrollments/search/{enrollment_date}", tags=["enrollments"],
                           description="Endpoint para obtener una inscripción específica por fecha. Solo Admin.",
                           response_model=EnrollmentResponse)
