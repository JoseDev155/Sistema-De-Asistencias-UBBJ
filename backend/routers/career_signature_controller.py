...
@career_signature_controller.get("/career-signatures", tags=["career-signatures"],
                                 description="Endpoint para obtener todas las carrera-asignatura del sistema. Solo Admin.",
...
@career_signature_controller.get("/career-signatures/{id}", tags=["career-signatures"],
                                 description="Endpoint para obtener una carrera-asignatura específica por su ID. Solo Admin.",
